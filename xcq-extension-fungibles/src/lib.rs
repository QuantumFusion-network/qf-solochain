...
decl_extensions! {
    pub trait ExtensionFungibles {
        ...
        fn transfer(
            from_asset: <Self::Config as Config>::AssetId,
            from_who: <Self::Config as Config>::AccountId,
            to_asset: <Self::Config as Config>::AssetId,
            to_who: <Self::Config as Config>::AccountId,
